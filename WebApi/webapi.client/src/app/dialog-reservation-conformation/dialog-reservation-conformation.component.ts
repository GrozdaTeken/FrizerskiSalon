...
@Component({
  selector: 'app-dialog-reservation-conformation',
  templateUrl: './dialog-reservation-conformation.component.html',
  styleUrl: './dialog-reservation-conformation.component.css'
})
export class DialogReservationConformationComponent {
